...
storeLocator.Store.prototype.getInfoWindowContent = function() {
  if (!this.content_) {
    ...
    var fields = ['title', 'address', 'tel', 'hours'];
    var html = ['<div class="infowindow-store">'];
...
storeLocator.Store.prototype.getInfoWindowContentList = function() {
  if (!this.content_) {
    // TODO(cbro): make this a setting?
...
storeLocator.Store.prototype.getInfoPanelContent = function() {
  return this.getInfoWindowContentList();
};
